...
public class HLThethongbienbaoduongboActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        hlt_lvnavigation.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    Toast.makeText(HLThethongbienbaoduongboActivity.this, e.toString(), Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
    ...
    private void createListViewAnswer(int index) throws Exception {
        ...
        AnswerAdapter adapter = new AnswerAdapter(HLThethongbienbaoduongboActivity.this,R.layout.item_listview_hoclythuyet,array);
