...
public class HLTsahinhActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hltsahinh);
        ...
        hlt_lvnavigation.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    Toast.makeText(HLTsahinhActivity.this, e.toString(), Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
    ...
    private void createListViewAnswer(int index) throws Exception {
        ...
        AnswerAdapter adapter = new AnswerAdapter(HLTsahinhActivity.this,R.layout.item_listview_hoclythuyet,array);
